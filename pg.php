...
if(isset($_POST["submit"])){
  ...
  $result = mysqli_query($conn, "SELECT * FROM pg ");
...
<div class="grid justify-items-stretch">
  <div class="justify-self-end mr-4 mt-2"> <button  class="  ml-96  text-white bg-black font-medium rounded-md shadow-md text-sm h-8 w-28"> <a href="addpg.php">Add PG </a> </button>
</div>
<div class="text-center mt-12 font-serif font-bold text-xl underline underline-offset-4">Registered PG's</div>
  <div class="relative overflow-x-auto">
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 mt-8 mx-1 mb-16">
