...
<section class="relative z-10 overflow-hidden   lg:py-[120px]">
      ...
      <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
        <div class="mb-12 max-w-[570px] lg:mb-0">
          ...
          <p class="text-body-color mb-9 text-base leading-relaxed">
           We'd love to hear from you! If you have any questions, comments, or concerns, please don't hesitate to reach out to us. Our customer support team is available to assist you in any way they can.
          </p>
          ...
          <div class="mb-8 flex w-full max-w-[370px]">
            ...
            <div class="w-full">
              ...
              <p class="text-body-color text-base">(+91)81 414 257 9980</p>
            </div>
          </div>
          <div class="mb-8 flex w-full max-w-[370px]">
            <div
